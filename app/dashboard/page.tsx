  ...
  return (
    <main className="min-h-screen text-white overflow-hidden">
      ...
      <section className="relative px-6 md:px-10 py-24">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-600/30 via-blue-700/20 to-indigo-900/30 blur-3xl"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-extrabold leading-tight mb-8">
            ...
            <p className="text-2xl text-gray-300 max-w-4xl leading-relaxed mb-12">

              AI-powered accessibility, transportation,
              emergency response, communication,
              food delivery and smart city integration
